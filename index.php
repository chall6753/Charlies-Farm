...
$sql = "SELECT id, temp_air, humidity, temp_water, pH, ec, ph_up_pump, ph_down_pump, pmp_a, pmp_b, date FROM sensor_data ORDER BY id DESC"; /*select items to display from the sensordata table in the data base*/
